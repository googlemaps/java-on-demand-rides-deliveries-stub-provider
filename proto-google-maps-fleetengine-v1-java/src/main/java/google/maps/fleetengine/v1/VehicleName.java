...
public class VehicleName implements ResourceName {
  private static final PathTemplate PROVIDER_VEHICLE =
      PathTemplate.createWithoutUrlEncoding("providers/{provider}/vehicles/{vehicle}");
  ...
  private VehicleName(Builder builder) {
  ...
  public static VehicleName of(String provider, String vehicle) {
  ...
  public static VehicleName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROVIDER_VEHICLE.validatedMatch(
            formattedString, "VehicleName.parse: formattedString not in valid format");
    return of(matchMap.get("provider"), matchMap.get("vehicle"));
  }

  public static List<VehicleName> parseList(List<String> formattedStrings) {
    List<VehicleName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<VehicleName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (VehicleName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      VehicleName that = ((VehicleName) o);
  ...
  /** Builder for providers/{provider}/vehicles/{vehicle}. */
